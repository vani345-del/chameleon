    ...
    <div className='p-4'>
      ...
      <div className="mb-6">
        ...
        {categories.map((category)=>(
          <div  key={category} className="flex items-center b-1">
            <input type="radio"
            name="category"
            value={category}
      ...
      <div className="mb-6">
        ...
        {genders.map((gender)=>(
          <div  key={gender} className="flex items-center b-1">
            <input type="radio"
            name="gender"
            value={gender}
            onChange={handleFilterChange}
      ...
      <div className="flex flex-wrap gap-2">
        {colors.map((color)=>(
          ...
          className={`w-8 h-8 rounded-full border border-gray-300 curser-pointer transition hover:scale-105 ${filters.color===color ? "ring-2 ring-blue-500":""}`}
